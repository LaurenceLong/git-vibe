 ...
 * - Reuse existing CommentComposer component
 */
 ...
 */
export function ConversationTab({ prId }: ConversationTabProps) {
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Be the first to leave a comment on this PR"
        />
      )}
    </div>
  );
