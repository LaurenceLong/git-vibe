...
export class GitMirrorService {
   ...
   */
  async ensureMirrorRepo(mirrorsDir: string, sourceRepoPath: string): Promise<string> {
   ...
   */
  private async createMirrorRepo(mirrorRepoPath: string, sourceRepoPath: string): Promise<void> {
